###########################################################################
## Makefile generated for Simulink model 'Dynamics'. 
## 
## Makefile     : Dynamics.mk
## Generated on : Wed Jul 20 21:36:52 2016
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Dynamics.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Dynamics_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Dynamics_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Dynamics.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Dynamics_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Dynamics -DNUMST=2 -DNCSTATES=21 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Dynamics_grt_rtw/Dynamics.c $(START_DIR)/Dynamics_grt_rtw/Dynamics_data.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
OBJS = Dynamics.obj Dynamics_data.obj
...
%.obj : $(START_DIR)/Dynamics_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
