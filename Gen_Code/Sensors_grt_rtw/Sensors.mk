###########################################################################
## Makefile generated for Simulink model 'Sensors'. 
## 
## Makefile     : Sensors.mk
## Generated on : Wed Jul 20 22:40:26 2016
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Sensors.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Sensors_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Sensors.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Sensors_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Sensors -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Sensors_grt_rtw/Sensors.c $(START_DIR)/Sensors_grt_rtw/Sensors_data.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
OBJS = Sensors.obj Sensors_data.obj
...
%.obj : $(START_DIR)/Sensors_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
