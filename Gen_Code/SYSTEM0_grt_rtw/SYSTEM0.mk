###########################################################################
## Makefile generated for Simulink model 'SYSTEM0'. 
## 
## Makefile     : SYSTEM0.mk
## Generated on : Wed Jul 20 23:23:49 2016
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SYSTEM0.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = SYSTEM0_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = SYSTEM0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SYSTEM0.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/SYSTEM0_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_BUILD_ARGS = -DMAT_FILE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0
DEFINES_IMPLIED = -DTID01EQ=1
DEFINES_STANDARD = -DMODEL=SYSTEM0 -DNUMST=4 -DNCSTATES=21 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/SYSTEM0_grt_rtw/SYSTEM0.c $(START_DIR)/SYSTEM0_grt_rtw/SYSTEM0_data.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
OBJS = SYSTEM0.obj SYSTEM0_data.obj
...
%.obj : $(START_DIR)/SYSTEM0_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
