...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DynModel.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = DynModel_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = DynModel_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DynModel.exe
...
SRCS = $(START_DIR)/DynModel_grt_rtw/DynModel.c $(START_DIR)/DynModel_grt_rtw/DynModel_data.c $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
...
OBJS = DynModel.obj DynModel_data.obj
...
%.obj : $(START_DIR)/DynModel_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
